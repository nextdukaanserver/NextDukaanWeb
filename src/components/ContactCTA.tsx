...
const WA_LINK = "https://wa.me/919999999999?text=Hi%20NextDukaan%2C%20I%20want%20to%20get%20started!";
          ...
          <div className="glass rounded-2xl p-8">
            ...
            {status === 'success' && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">We've also opened WhatsApp so you can reach us instantly.</p>
                </div>
              </motion.div>
            )}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4" noValidate>
              ...
              <p className="text-center text-xs text-slate-600">
                ...
                <a href="mailto:nextdukaan.bussiness@gmail.com" className="text-green-500 hover:text-green-400 transition-colors">
                  nextdukaan.bussiness@gmail.com
                </a>
              </p>
            </form>
          </div>
